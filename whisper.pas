...
begin
  ...
  result.n_max_text_ctx := 50; //0 = radical. Cela signifie que Whisper n'a aucune mémoire de ce qu'il a dit juste avant. C'est très rapide, mais la grammaire peut en souffrir.
