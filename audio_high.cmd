...
ffmpeg -i "%~1" -ar 16000 -ac 1 -c:a pcm_s16le -af "highpass=f=80, lowpass=f=12000, afftdn=nf=-30, agate=threshold=-35dB:ratio=3:attack=5:release=50, loudnorm=I=-23:LRA=7:TP=-2" "%~dpn1_whisper.wav"
